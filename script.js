...
$(document).ready(function () {
   ...
   // speeches.push(new SpeechType("Evaluation", "2:00", "2:30", "3:00", "st-evaluation"));
    speeches.push(new SpeechType("Temas generales", "4:00", "5:00", "8:00", "st-icebreaker"));
    speeches.push(new SpeechType("Revisión individual", "3:00", "5:00", "6:00", "st-standard"));
